    ...
    <div className="max-w-2xl mx-auto space-y-6 p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 pb-6 -mt-8">
          ...
          <div className="mt-3">
            <h2 className="text-xl font-semibold text-gray-900">{me?.display_name ?? me?.email}</h2>
          ...
          <div>
            ...
            {editing ? (
              ...
              <div className="flex items-center gap-3">
                <p className="text-gray-900">{me?.display_name || <span className="text-gray-400 italic">Not set</span>}</p>
                <button
